...
I talked about <a href="../2019-05-14/azure-cosmos-db-review" title="Cosmos DB review, pros and cons">pros and cons of Cosmos DB</a> in my previous post, and mentioned that we migrated from Cosmos DB Mongo API to SQL API with a few tricks. I'm going to explain those tricks in this post.
