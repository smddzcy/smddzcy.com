...
By the way, lambdas are not just fancied anonymous classes. They separate themselves from anonymous classes in the lower levels of Java. Some of the differences between them are listed below.
