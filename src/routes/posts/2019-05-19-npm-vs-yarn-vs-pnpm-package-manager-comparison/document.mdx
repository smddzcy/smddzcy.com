...
- It deduplicates the Node packages all over your system by using symlinks, meaning you will have a single copy of `lodash` in your system from now on (yay 🎉). I saved 15 gigs of space last week just by switching to pnpm!
